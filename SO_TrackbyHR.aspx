<%@ Page Title="SO_TrackbyHR" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SO_TrackbyHR.aspx.cs" Inherits="SO_Appraisal.SO_TrackbyHR" %>
    ...
    <div class="container body-content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-6 col-md-3 mb-2 mb-md-0">
                    <div class="floating-label">
                        ...
                        <input type="text" id="StateDrpSearch" runat="server" class="form-control" style="display: none" placeholder="Enter State" />
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-2 mb-md-0">
                    <div class="floating-label">
                        ...
                        <label for="AreaDrp">Area</label>

                        <input type="text" id="AreaDrpSearch" runat="server" class="form-control" style="display: none" placeholder="Enter Area" />
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-2 mb-md-0">
                    <div class="floating-label">
                        ...
                        <input type="text" id="ZoneDrpSearch" runat="server" class="form-control" style="display: none" placeholder="Enter Zone" />
                    </div>
                </div>

                <%--<div class="col-6 col-md-3 mb-2 mb-md-0">
                    <div class="floating-label">
                        <asp:DropDownList ID="SODrp" runat="server" AutoPostBack="true" class="form-control" OnSelectedIndexChanged="SODrp_SelectedIndexChanged">
                            <asp:ListItem Text="SO" Value=""></asp:ListItem>
                        </asp:DropDownList>
                        <label for="SODrp">SO</label>

                        <input type="text" id="SODrpSearch" runat="server" class="form-control" style="display: none" placeholder="Enter SO Code" />
                    </div>
                </div>--%>
                ...
                <div class="col-6 col-md-3 mb-2 mb-md-0">
                    <div class="floating-label">
                        <asp:DropDownList ID="FYDrp" runat="server" AutoPostBack="true" class="form-control" OnSelectedIndexChanged="FYDrp_SelectedIndexChanged">
                            <asp:ListItem Text="FY" Value=""></asp:ListItem>
            ...
            <div class="row mt-3">
                ...
                <div class="col-6 col-md-3 mb-2 mb-md-0">
                    <asp:Button ID="FetchBtn" runat="server" Text="Fetch" CssClass="btn btn-primary form-control" OnClick="FetchBtn_Click" />
                </div>
            ...
            <div class="container mt-4">
                ...
                <div class="dashboard-wrapper">
                    ...
                    <div class="row dashboard-row">
                        ...
                        <div class="col-md-6">
                            <div class="dashboard-card">
                                <div class="dashboard-card-title">Achievement(PresentYear)</div>
